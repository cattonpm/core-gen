<script>
    ...
    onMount(() => {
        const cleanup = (async function() {
            ...
            if (response.ok) {
                ...
                const updateStatuses = () => {
                    ...
                    // Update items reactively by assigning the new array
        ...
        // Return cleanup function that waits for the async operation to complete
...
<Seo title={"Core Gen - NFT Laundpad on Core"} description={"Core Gen offers a free Launchpad for NFTs on Core, allowing both projects and individuals to launch their NFT collections for free"} keywords={"Core NFT Launchpad , launch nft, mint nft"}/>
<div class="flex font-Hoves bg-black w-full min-h-screen text-white">
    <div class="flex flex-col w-full max-w-screen-2xl mx-auto sm:px-[33px] px-[10px]">
        <div class="flex flex-col">
            <Nav/>
            <button class="text-xl py-1 self-start font-semibold mt-[20px] text-white bg-button hover:bg-buttonHover rounded-md px-4"
            on:click={()=>goto(`../launchpad/mylaunch`)}>
                Launch your NFT
            </button>
            <!--Featured mint collection-->
            {#if !items[0].name}
                                ...
                                <div class="flex flex-col w-full gap-[5px] ">
                                    <div class="flex flex-wrap w-full justify-between mt-[10px]">
                                        ...
                                        <div class="flex items-center gap-[5px]">
                                            ...
                                            <img class="h-[15px] inline-block border-[1px] border-darkGray rounded-full" src="/icons/CORE.png"/>-->
                                        </div>
                                    </div>
                                </div>
                            </div>
