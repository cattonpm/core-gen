...
<Seo title={"Core Gen - NFT Collections on Core"} description={"Discover and trade NFT collections on Core Gen, NFT marketplace on Core. Start your journey with us today!"} keywords={"Core, NFT , Collections, Core Gen"}/>
